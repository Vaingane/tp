...
class TwigController extends AbstractController
{
    ...
    public function vue6Action() : Response
    {
        $args = array(
            'prenom' => 'Nathan',
            'mail' => 'nathan.suchaire@lp2i-poitiers.fr',
            'offre' => $this->getOffreFormations(),
        );
        return $this->render('Sandbox/Twig/vue6.html.twig', $args);
    }

    public function palmaresAction(int $nbproduits) : Response{
        //Intérrogation à la base de données
        $produits = [];
    ...
    private function getOffreFormations(){
        $tab = array (
